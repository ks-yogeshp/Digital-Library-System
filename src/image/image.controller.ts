import { Controller, FileTypeValidator, HttpStatus, MaxFileSizeValidator, Param, ParseFilePipe, Res, StreamableFile, UploadedFile, UseInterceptors } from '@nestjs/common';
...
@GetRoute('{:type}/{:id}',{
    ...
    // Ok: 'Returns the image file as a StreamableFile',
})
